...
$new_node_path="$basedir\E:\web开发\项目\vue+express+mysql\serve\node_modules\.store\@mapbox+node-pre-gyp@1.0.11\node_modules\@mapbox"
if ($PSVersionTable.PSVersion -lt "6.0" -or $IsWindows) {
  ...
  $new_node_path="$basedir/E:/web开发/项目/vue+express+mysql/serve/node_modules/.store/@mapbox+node-pre-gyp@1.0.11/node_modules/@mapbox"
}
